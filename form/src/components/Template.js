...
const Template=({title,desc1,desc2,image,formtype,setIsloggedin})=>{
    return(
        <div className=' flex relative w-11/12 max-w-[1160px] py-12 mx-auto gap-x-20 gap-y-0 justify-between'>
            ...
            <div className=' relative w-11/12 max-w-[450px]'>
                ...
                <img src={frame} alt="pattern" width={558} height={584} loading="lazy" />
